...
func (b *testBackend) OverallSent(daemon, asset string, amount float64)     {}
func (b *testBackend) OverallReceived(daemon, asset string, amount float64) {}
func (b *testBackend) OverallFee(daemon, asset string, amount float64)      {}
