...
//		return errors.Errorf("either conf_target or sat_per_byte should be " +
//			"set, but not both")
//	}
//
//	switch {
...
//		args = args.Tail()
//	default:
//		return errors.Errorf("Address argument missing")
//	}
//
//	switch {
//	case ctx.IsSet("amt"):
...
//	default:
//		return errors.Errorf("Amount argument missing")
//	}
//
//	if err != nil {
//		return errors.Errorf("unable to decode amount: %v", err)
//	}
//
//	ctxb := context.Background()
//	client, cleanUp := getClient(ctx)
...
//	if len(splitAddr) != 2 {
//		return errors.Errorf("target address expected in format: " +
//			"pubkey@host:port")
//	}
//
...
//	default:
//		return errors.Errorf("must specify target public key")
//	}
//
...
//		if err != nil {
//			return errors.Errorf("unable to decode node public key: %v", err)
//		}
...
//		req.NodePubkey = nodePubHex
//	default:
//		return errors.Errorf("node id argument missing")
//	}
//
...
//		if err != nil {
//			return errors.Errorf("unable to decode local amt: %v", err)
//		}
//		args = args.Tail()
//	default:
//		return errors.Errorf("local amt argument missing")
//	}
//
...
//		if err != nil {
//			return errors.Errorf("unable to decode push amt: %v", err)
//		}
//	}
//
...
//		args = args.Tail()
//	default:
//		return errors.Errorf("funding txid argument missing")
//	}
//
//	switch {
...
//		if err != nil {
//			return errors.Errorf("unable to decode output index: %v", err)
//		}
...
//	if err != nil {
//		return errors.Errorf("unable to fetch open channels: %v", err)
//	}
//
...
//			return errors.Errorf("wrong cipher seed mnemonic "+
...
//				return errors.Errorf("cipher seed pass phrases " +
//					"don't match")
//			}
//		}
//
...
//		if err != nil {
//			return errors.Errorf("unable to generate seed: %v", err)
//		}
//
...
//		return nil, errors.Errorf("either fee_limit or fee_limit_percent " +
...
//		args = args.Tail()
//	default:
//		return errors.Errorf("destination txid argument missing")
//	}
//	if err != nil {
//		return err
//	}
//
//	if len(destNode) != 33 {
//		return errors.Errorf("dest node pubkey must be exactly 33 bytes, is "+
...
//		args = args.Tail()
//		if err != nil {
//			return errors.Errorf("unable to decode payment amount: %v", err)
//		}
//	}
//
//	req := &lnrpc.SendRequest{
...
//		return errors.Errorf("do not provide a payment hash with debug send")
...
//		default:
//			return errors.Errorf("payment hash argument missing")
//		}
//
//		if err != nil {
//			return err
//		}
//		if len(rHash) != 32 {
//			return errors.Errorf("payment hash must be exactly 32 "+
...
//		payReq = args.First()
//	default:
//		return errors.Errorf("pay_req argument missing")
//	}
//
//	feeLimit, err := retrieveFeeLimit(ctx)
//	if err != nil {
...
//		}
//		if len(b) == 0 {
//			return errors.Errorf("queryroutes output is empty")
//		}
//
//		jsonRoutes = string(b)
//	}
...
//	if err != nil {
//		return errors.Errorf("unable to unmarshal json string "+
...
//		args = args.Tail()
//		if err != nil {
//			return errors.Errorf("unable to decode amt argument: %v", err)
//		}
//	}
//
//	switch {
...
//
//	if err != nil {
//		return errors.Errorf("unable to parse preimage: %v", err)
//	}
//
//	descHash, err = hex.DecodeString(ctx.String("description_hash"))
//	if err != nil {
//		return errors.Errorf("unable to parse description_hash: %v", err)
//	}
//
//	receipt, err = hex.DecodeString(ctx.String("receipt"))
//	if err != nil {
//		return errors.Errorf("unable to parse receipt: %v", err)
//	}
//
...
//	default:
//		return errors.Errorf("rhash argument missing")
//	}
//
//	if err != nil {
//		return errors.Errorf("unable to decode rhash argument: %v", err)
//	}
//
...
//	default:
//		return errors.Errorf("chan_id argument missing")
//	}
//
...
//		pubKey = args.First()
//	default:
//		return errors.Errorf("pub_key argument missing")
//	}
//
...
//		args = args.Tail()
//	default:
//		return errors.Errorf("dest argument missing")
//	}
//
//	switch {
//	case ctx.IsSet("amt"):
...
//		}
//	default:
//		return errors.Errorf("amt argument missing")
//	}
//
//	feeLimit, err := retrieveFeeLimit(ctx)
//	if err != nil {
...
//	default:
//		return errors.Errorf("msg argument missing")
//	}
//
...
//		sig = args.First()
//	default:
//		return errors.Errorf("signature argument missing")
//	}
//
...
//		if err != nil {
//			return errors.Errorf("unable to decode base_fee_msat: %v", err)
//		}
//		args = args.Tail()
//	default:
//		return errors.Errorf("base_fee_msat argument missing")
//	}
//
//	switch {
...
//		if err != nil {
//			return errors.Errorf("unable to decode fee_rate: %v", err)
//		}
//
//		args = args.Tail()
//	default:
//		return errors.Errorf("fee_rate argument missing")
//	}
//
//	switch {
...
//		if err != nil {
//			return errors.Errorf("unable to decode time_lock_delta: %v",
//				err)
//		}
//
//		args = args.Tail()
//	default:
//		return errors.Errorf("time_lock_delta argument missing")
//	}
//
//	var (
...
//		if len(split) != 2 {
//			return errors.Errorf("expecting chan_point to be in format of: " +
//				"txid:index")
//		}
//
...
//		if err != nil {
//			return errors.Errorf("unable to decode start_time %v", err)
//		}
//		args = args.Tail()
//	}
//
...
//		if err != nil {
//			return errors.Errorf("unable to decode end_time: %v", err)
//		}
//		args = args.Tail()
//	}
//
...
//		if err != nil {
//			return errors.Errorf("unable to decode index_offset: %v", err)
//		}
...
//		if err != nil {
//			return errors.Errorf("unable to decode max_events: %v", err)
//		}
//		maxEvents = uint32(m)
//		args = args.Tail()
//	}
